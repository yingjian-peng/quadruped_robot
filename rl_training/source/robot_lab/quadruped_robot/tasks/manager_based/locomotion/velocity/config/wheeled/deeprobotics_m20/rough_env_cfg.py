...
from quadruped_robot.tasks.manager_based.locomotion.velocity.velocity_env_cfg import (
    ActionsCfg,
...
# Pre-defined configs
##
from quadruped_robot.assets.deeprobotics import DEEPROBOTICS_M20_CFG  # isort: skip
