...
from robot_lab.assets import ROBOT_MODELS_DIR
...
UNITREE_A1_CFG = ArticulationCfg(
    spawn=sim_utils.UrdfFileCfg(
        ...
        asset_path=f"{ROBOT_MODELS_DIR}/unitree/a1_description/urdf/a1.urdf",
...
UNITREE_GO2_CFG = ArticulationCfg(
    spawn=sim_utils.UrdfFileCfg(
        ...
        merge_fixed_joints=True,
        replace_cylinders_with_capsules=False,
        asset_path=f"{ROBOT_MODELS_DIR}/unitree/go2_description/urdf/go2_description.urdf",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
...
UNITREE_GO2W_CFG = ArticulationCfg(
    spawn=sim_utils.UrdfFileCfg(
        ...
        merge_fixed_joints=True,
        replace_cylinders_with_capsules=False,
        asset_path=f"{ROBOT_MODELS_DIR}/unitree/go2w_description/urdf/go2w_description.urdf",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
...
UNITREE_B2_CFG = ArticulationCfg(
    spawn=sim_utils.UrdfFileCfg(
        ...
        merge_fixed_joints=True,
        replace_cylinders_with_capsules=False,
        asset_path=f"{ROBOT_MODELS_DIR}/unitree/b2_description/urdf/b2_description.urdf",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
...
UNITREE_B2W_CFG = ArticulationCfg(
    spawn=sim_utils.UrdfFileCfg(
        ...
        merge_fixed_joints=True,
        replace_cylinders_with_capsules=False,
        asset_path=f"{ROBOT_MODELS_DIR}/unitree/b2w_description/urdf/b2w_description.urdf",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
