"""Create the Go2-ARX Isaac Lab environment and execute one zero-action step."""
...
parser = argparse.ArgumentParser(description="Run a Go2-ARX Isaac Lab smoke test.")
...
def main() -> None:
    ...
    task_id = "Go2-Arx-LocoManip-Flat-v0"
    ...
    print(f"JOINTS {env.unwrapped.scene['robot'].joint_names}")
    env.close()
